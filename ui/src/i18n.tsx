...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    helpSettings: "Configure storage folder and llama-server path in Settings before first run.",
    helpLogs: "Check Logs to see backend and llama-server output.",
    helpCli: "CLI: npm run aurora -- <cmd> (pull/run/chat/generate).",
  ...
  es: {
    ...
    helpSettings: "Configura carpeta y ruta de llama-server en Ajustes antes de usar.",
    helpLogs: "Revisa Logs para ver la salida del backend y llama-server.",
    helpCli: "CLI: npm run aurora -- <cmd> (pull/run/chat/generate).",
  ...
  fr: {
    ...
    helpSettings: "Réglez le dossier et le chemin de llama-server dans Réglages avant usage.",
    helpLogs: "Consultez Logs pour la sortie backend et llama-server.",
    helpCli: "CLI : npm run aurora -- <cmd> (pull/run/chat/generate).",
  ...
  de: {
    ...
    helpSettings: "Speicherordner und llama-server Pfad unter Einstellungen setzen.",
    helpLogs: "Logs prüfen für Backend- und llama-server-Ausgabe.",
    helpCli: "CLI: npm run aurora -- <cmd> (pull/run/chat/generate).",
  ...
  ar: {
    ...
    helpSettings: "عيّن مجلد النماذج ومسار llama-server في الإعدادات أولاً.",
    helpLogs: "راجع السجلات لعرض خرج الخادم و llama-server.",
    helpCli: "CLI: npm run aurora -- <cmd> (pull/run/chat/generate).",
  ...
  tr: {
    ...
    helpSettings: "Önce Ayarlar'da klasör ve llama-server yolunu ayarla.",
    helpLogs: "Kayıtları backend/llama-server çıktısı için kontrol et.",
    helpCli: "CLI: npm run aurora -- <cmd> (pull/run/chat/generate).",
  ...
  fa: {
    ...
    helpSettings: "قبل از شروع، مسیر مدل و llama-server را در تنظیمات وارد کنید.",
    helpLogs: "لاگ‌ها را برای خروجی بک‌اند و llama-server ببینید.",
    helpCli: "CLI: npm run aurora -- <cmd> (pull/run/chat/generate).",
  ...
  zh: {
    ...
    helpSettings: "首次使用前在 设置 中填好存储目录和 llama-server 路径。",
    helpLogs: "查看 日志 以了解后端和 llama-server 输出。",
    helpCli: "CLI：npm run aurora -- <cmd>（pull/run/chat/generate）。",
    plansTitle: "重型模型订阅",
